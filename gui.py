            ...
            with gr.Column(scale=2):
                with gr.Tabs():
                    ...
                    with gr.TabItem("Advanced Parameters"):
                        ...
                        probe_marker_input = gr.Code(label="Probe Marker", info="e.g., </think>. The string marker to probe activations after. Defaults to model's chat template or last token if blank.", language="text")
